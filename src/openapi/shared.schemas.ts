...
export const HomeSchema = {
  ...
  properties: {
    ...
    admin: { type: ['object', 'null'], properties: { id: { type: 'string' }, name: { type: 'string' } } },
    personInCharge: { type: ['object', 'null'], properties: { id: { type: 'string' }, name: { type: 'string' } } },
    responsibleIndividual: { type: ['object', 'null'], properties: { id: { type: 'string' }, name: { type: 'string' } } },
    startDate: { type: ['string', 'null'] },
    endDate: { type: ['string', 'null'] },
    isSecure: { type: 'boolean' },
    shortTermStays: { type: 'boolean' },
    minAgeGroup: { type: ['integer', 'null'] },
    maxAgeGroup: { type: ['integer', 'null'] },
    ofstedUrn: { type: ['string', 'null'] },
    compliance: {},
    details: {},
    counts: {
      type: 'object',
...
export const YoungPersonSchema = {
  ...
  properties: {
    ...
    keyWorker: { type: ['object', 'null'], properties: { id: { type: 'string' }, name: { type: 'string' } } },
    practiceManager: { type: ['object', 'null'], properties: { id: { type: 'string' }, name: { type: 'string' } } },
    admin: { type: ['object', 'null'], properties: { id: { type: 'string' }, name: { type: 'string' } } },
    socialWorkerName: { type: ['string', 'null'] },
    independentReviewingOfficer: { type: ['string', 'null'] },
    placingAuthority: { type: ['string', 'null'] },
