...
async function main() {
  ...
  const careGroup = await prisma.careGroup.upsert({
    ...
    update: {
      description: 'Residential and specialist homes across Yorkshire and the North West',
      type: 'Residential',
      managerName: 'Izu Obani',
      contactName: 'Gabriel Femi',
      phoneNumber: '0113 496 2200',
      email: 'northern@zikel.dev',
      website: 'https://zikel.dev',
      addressLine1: '1 Fortuna Way',
      city: 'Leeds',
  ...
  const southernCareGroup = await prisma.careGroup.upsert({
    ...
    update: {
      description: 'Residential and short-stay homes across the south of England',
      type: 'Residential',
      managerName: 'Amina Okafor',
      contactName: 'Amina Okafor',
      phoneNumber: '0117 496 3300',
      email: 'southern@zikel.dev',
      addressLine1: '5 Lakeside Drive',
      city: 'Bristol',
      county: 'Bristol',
      postcode: 'BS1 3DE',
      country: 'United Kingdom',
  ...
  const midlandsCareGroup = await prisma.careGroup.upsert({
    ...
    update: {
      description: 'Secure and residential homes across the Midlands',
      type: 'Secure',
      managerName: 'Juadeb Gabriel',
      contactName: 'Juadeb Gabriel',
      phoneNumber: '0121 496 4400',
      email: 'midlands@zikel.dev',
      addressLine1: '22 Willow Road',
      city: 'Birmingham',
